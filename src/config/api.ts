...
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://api.onedu.uz/api';
...
export const API_ENDPOINTS = {
  ...
  EXAM_QUESTIONS_LIST: '/exams/questions/',
  EXAM_QUESTION_DETAIL: (questionId: string | number) => `/exams/questions/${questionId}/`,
  EXAM_ANSWERS: '/exams/answers/',
  EXAM_ANSWER_DETAIL: (answerId: string | number) => `/exams/answers/${answerId}/`,
  STUDENT_EXAMS: '/exams/student-exams/',
  STUDENT_EXAM_DETAIL: (studentExamId: string | number) => `/exams/student-exams/${studentExamId}/`,
  STUDENT_EXAM_QUESTIONS: (studentExamId: string | number) => `/exams/student-exams/${studentExamId}/questions/`,
